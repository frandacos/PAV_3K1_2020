...
public class DataManager
{
    ...
    public DataManager()
    {
       ...
       // var string_conexion = ConfigurationManager.ConnectionStrings[dataBaseName].ConnectionString;
        dbConnection.ConnectionString = @"Data Source=sql5080.site4now.net;Initial Catalog=DB_A674C1_BugsTrackerEx;Persist Security Info=True;User ID=DB_A674C1_BugsTrackerEx_admin";
    }
