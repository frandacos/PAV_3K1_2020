...
namespace BugTracker
{
    public class DBHelper
    {
        ...
        private DBHelper()
        {
            string_conexion = @"Data Source=DESKTOP-J7D7ML8\SQLEXPRESS;Initial Catalog=BugsTrackerEx;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
