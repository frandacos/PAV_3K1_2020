...
public class DataManager
{
    ...
    public DataManager()
    {
        ...
        dbConnection.ConnectionString = @"Data Source=sql5080.site4now.net;Initial Catalog=DB_A674C1_FRANCO;User ID=DB_A674C1_FRANCO_admin;Password=Ardacos73;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
